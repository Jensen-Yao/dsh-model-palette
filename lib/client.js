window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function mediaModelEnabled(model, allowPaid) {
		...
		function MediaPanel({ t }) {
			...
			const submitImage = () => run("image", async () => {
				...
				return {
					...
					detail: result.files.map((file) => file.path).join("\n")
				};
			});
			const submitVideo = () => run("video", async () => {
				...
				return {
					...
					detail: `${result.id}${result.status === void 0 ? "" : ` · ${result.status}`}`
				};
			});
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("media.model") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										children: [
											...
											images.length > 0 && !imageSelectionAvailable && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "",
												children: t("media.noAllowedModels")
											}),
											images.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: model.id,
												disabled: !mediaModelEnabled(model, paidImagesEnabled),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									type: "button",
									disabled: busy || !imageSelectionAvailable,
							...
							children: [
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("media.model") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										children: [
											...
											videos.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: model.id,
												disabled: !mediaModelEnabled(model, paidVideosEnabled),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									className: "dmp-media-primary",
									type: "button",
									disabled: busy || !videoSelectionAvailable,
