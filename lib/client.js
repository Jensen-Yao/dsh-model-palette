	...
	factory: (require) => {
		...
		const CUSTOM_TEMPLATES = [
			...
			},
			{
				...
				category: "custom",
				icon: "google",
				hint: "generativelanguage.googleapis.com · google-generative-ai",
				oauthOnly: false
			}
		];
		...
		const API_KEY_TEMPLATES = [
			...
			},
			{
				...
				displayName: "Kimi For Coding (API)",
				category: "api-key",
				icon: "kimi",
		...
		const BRAND_RULES = [
			...
			},
			{
				icon: "google",
				brandName: "Google",
				patterns: [/google|gemini|generativelanguage/iu]
			},
			{
				icon: "moonshot",
			...
			},
			{
				icon: "qwen",
				brandName: "Qwen",
				patterns: [/qwen|alibaba|aliyun|dashscope/iu]
			},
			{
				icon: "xai",
				brandName: "xAI",
		...
		var model_presets_default = {
			...
			presets: [
				...
				},
				{
					...
					"aliases": ["deepseek-r1-0528", "deepseek/deepseek-r1-0528"],
					"contextWindow": 163840,
					"maxTokens": 32768,
					"input": ["text"],
					"sourceLabel": "OpenRouter models",
				...
				},
				{
					...
					"aliases": ["glm-4-6v", "z-ai/glm-4-6v"],
					"contextWindow": 131072,
					"maxTokens": 32768,
					"input": ["text", "image"],
					"sourceLabel": "OpenRouter models",
				...
				},
				{
					...
					"aliases": ["glm-4-7-flash", "z-ai/glm-4-7-flash"],
				...
				},
				{
					...
					"aliases": ["glm-5v-turbo", "z-ai/glm-5v-turbo"],
					"contextWindow": 202752,
					"maxTokens": 131072,
					"input": ["text", "image"],
					"sourceLabel": "OpenRouter models",
				...
				},
				{
					...
					"aliases": ["gpt-5-1-codex", "openai/gpt-5-1-codex"],
					"contextWindow": 4e5,
					"maxTokens": 128e3,
					"input": ["text", "image"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["gpt-5-1-codex-max", "openai/gpt-5-1-codex-max"],
					"contextWindow": 4e5,
					"maxTokens": 128e3,
					"input": ["text", "image"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["gpt-5-1-codex-mini", "openai/gpt-5-1-codex-mini"],
					"contextWindow": 4e5,
					"maxTokens": 128e3,
					"input": ["text", "image"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["gpt-5-2-codex", "openai/gpt-5-2-codex"],
					"contextWindow": 4e5,
					"maxTokens": 128e3,
					"input": ["text", "image"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["gpt-oss-120b", "openai/gpt-oss-120b"],
					"contextWindow": 131072,
					"maxTokens": 117964,
					"input": ["text"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["grok-build-0-1", "x-ai/grok-build-0-1"],
					"contextWindow": 256e3,
					"maxTokens": 230400,
					"input": ["text", "image"],
					"sourceLabel": "OpenRouter models",
				...
				},
				{
					...
					"aliases": ["hy4-preview", "tencent/hy4-preview"],
					"contextWindow": 1048576,
					"maxTokens": 64e3,
					"input": ["text"],
					"reasoningEfforts": {
				...
				},
				{
					...
					"aliases": ["step-3-5-flash", "stepfun/step-3-5-flash"],
					"contextWindow": 262144,
					"maxTokens": 65536,
					"input": ["text"],
					"sourceLabel": "OpenRouter models",
				...
				},
				{
					...
					"aliases": ["step-3-7-flash", "stepfun/step-3-7-flash"],
					"contextWindow": 256e3,
					"maxTokens": 230400,
					"input": ["text", "image"],
					"reasoningEfforts": {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							templateCatalogOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "dmp-config-template-catalog",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dmp-config-template-heading",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.templateTitle") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.templateHint") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									{
										key: "apiKey",
										label: t("config.templateApiKey"),
										templates: filterTemplates(API_KEY_TEMPLATES, templateQuery),
										blank: false
									}
