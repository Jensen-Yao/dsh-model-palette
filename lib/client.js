window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function providerBrandColor(id) {
			return BRAND_COLORS[id];
		}
		function ProviderIcon({ id, size = 20, colored = false }) {
			const glyph = GLYPHS[id] ?? GLYPHS.generic;
			const color = colored === true ? BRAND_COLORS[id] : void 0;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: size,
				height: size,
				viewBox: "0 0 24 24",
				fill: color ?? "currentColor",
				style: color === void 0 ? void 0 : { color },
				"aria-hidden": "true",
				focusable: "false",
			...
			presets: [
				{
					...
					"aliases": ["agnes-2-5-flash", "agnes-2.5-flash"],
					"contextWindow": 524288,
					"maxTokens": 65536,
					"input": ["text", "image"],
					"sourceLabel": "Agnes model docs",
					"sourceUrl": "https://wiki.agnes-ai.com/en/docs/agnes-25-flash"
				},
				{
					"id": "agnes-2-5-pro",
					"name": "Agnes 2.5 Pro",
					"aliases": ["agnes-2-5-pro", "agnes-2.5-pro"],
					"contextWindow": 1048576,
					"maxTokens": 65536,
					"input": ["text", "image"],
					"sourceLabel": "Agnes model docs",
					"sourceUrl": "https://wiki.agnes-ai.com/en/docs/agnes-25-pro"
				},
				{
					"id": "agnes-2-5-pro-beta",
					"name": "Agnes 2.5 Pro Beta",
					"aliases": ["agnes-2-5-pro-beta", "agnes-2.5-pro-beta"],
					"contextWindow": 1048576,
					"maxTokens": 65536,
					"input": ["text", "image"],
					"sourceLabel": "Agnes model docs",
					"sourceUrl": "https://wiki.agnes-ai.com/en/docs/agnes-25-pro-beta"
				},
				{
					"id": "agnes-3-0-flash",
					"name": "Agnes 3.0 Flash",
					"aliases": ["agnes-3-0-flash", "agnes-3.0-flash"],
					"contextWindow": 524288,
					"maxTokens": 65536,
					"input": ["text", "image"],
					"sourceLabel": "Agnes model docs",
					"sourceUrl": "https://wiki.agnes-ai.com/en/docs/agnes-30-flash"
				},
				{
				...
				},
				{
					...
					"contextWindow": 262144,
					"input": ["text"],
					"sourceLabel": "Cohere Command A docs",
				...
				},
				{
					...
					"maxTokens": 16384,
					"input": ["text"],
					"sourceLabel": "火山方舟模型列表",
					"sourceUrl": "https://www.volcengine.com/docs/82379/1799865"
				},
				{
					"id": "doubao-seed-1-6",
				...
				},
				{
					...
					"aliases": ["doubao-seed-2-0-code-preview", "doubao-seed-2.0-code-preview"],
					"contextWindow": 262144,
					"maxTokens": 131072,
					"input": ["text", "image"],
					"sourceLabel": "火山方舟模型列表",
				...
				},
				{
					"id": "hunyuan-a13b",
					"name": "Hunyuan A13B",
					"aliases": ["hunyuan-a13b", "hunyuan-a13b-260112"],
					"contextWindow": 262144,
					"maxTokens": 32768,
					"input": ["text"],
					"sourceLabel": "腾讯混元产品概述",
					"sourceUrl": "https://cloud.tencent.com/document/product/1729/104753"
				},
				{
					"id": "hunyuan-t1-vision",
					"name": "Hunyuan T1 Vision",
					"aliases": ["hunyuan-t1-vision", "hunyuan-t1-vision-20250916"],
					"maxTokens": 20480,
					"input": ["text", "image"],
					"sourceLabel": "腾讯混元产品概述",
					"sourceUrl": "https://cloud.tencent.com/document/product/1729/104753"
				},
				{
					...
					"aliases": ["hunyuan-vision-1-5-instruct", "hunyuan-vision-1.5-instruct"],
					"maxTokens": 16384,
					"input": ["text", "image"],
					"sourceLabel": "腾讯混元产品概述",
					"sourceUrl": "https://cloud.tencent.com/document/product/1729/104753"
				...
				},
				{
					...
					"aliases": ["sonar", "perplexity-sonar"],
					"contextWindow": 131072,
					"input": ["text"],
					"sourceLabel": "Perplexity model cards",
					"sourceUrl": "https://docs.perplexity.ai/models/model-cards"
				},
				{
					"id": "perplexity-sonar-pro",
					"name": "Perplexity Sonar Pro",
					"aliases": ["sonar-pro", "perplexity-sonar-pro"],
					"contextWindow": 204800,
					"input": ["text"],
					"sourceLabel": "Perplexity model cards",
					"sourceUrl": "https://docs.perplexity.ai/models/model-cards"
				},
				{
					...
					"aliases": ["sonar-pro-search", "perplexity-sonar-pro-search"],
					"contextWindow": 204800,
					"input": ["text"],
					"sourceLabel": "Perplexity model cards",
					"sourceUrl": "https://docs.perplexity.ai/models/model-cards"
				},
				{
					...
					"aliases": ["sonar-reasoning-pro", "perplexity-sonar-reasoning-pro"],
					"contextWindow": 131072,
					"input": ["text"],
					"sourceLabel": "Perplexity model cards",
					"sourceUrl": "https://docs.perplexity.ai/models/model-cards"
		...
		function formatTokenCount(value) {
			...
			if (value >= 1e6) {
				...
				return `${millions >= 10 ? String(Math.round(millions)) : millions.toFixed(millions % 1 === 0 ? 0 : 2).replace(/0+$/u, "").replace(/\.$/u, "")}M`;
			}
			if (value >= 1e3) return `${Math.round(value / 1e3)}k`;
			return String(value);
		}
		/** Render cap for long model lists: above the threshold only the first N rows render until expanded. */
		function applyModelRenderLimit(items, showAll) {
			if (showAll || items.length < 60) return {
				rendered: items,
				hidden: 0
			};
			return {
				rendered: items.slice(0, 50),
				hidden: items.length - 50
			};
		}
		...
		*/
		...
		function ConfigPanel({ api, isLoopback, mode = "config", onSwitchMode, t }) {
			...
			const [showAllModels, setShowAllModels] = (0, react.useState)(false);
			...
			const { rendered: renderedModels, hidden: hiddenModels } = (0, react.useMemo)(() => applyModelRenderLimit(visibleModels, showAllModels), [showAllModels, visibleModels]);
			...
			(0, react.useEffect)(() => {
				...
				api.credentials.describe({ refs }).then((response) => {
					...
					const next = {};
					for (const [ref, info] of Object.entries(response.result.value.credentials)) next[ref] = info?.configured === true ? "configured" : "missing";
			...
			if (mode === "catalog") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				className: "dmp-config dmp-config-catalog",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						className: "dmp-config-toolbar",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.templateTitle") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.templateHint") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dmp-config-toolbar-actions",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => onSwitchMode?.("config"),
								children: t("config.backToConfig")
							})
						})]
					}),
							...
							children: [
								group.templates.map((template) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: template.displayName }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: (() => {
											const liveCount = template.catalog === true ? liveCatalogModels[template.id]?.length : void 0;
											if (liveCount !== void 0) return t("config.templateModelCount", { count: liveCount });
											return template.hint ?? (template.models === void 0 ? t("config.templateOauth") : t("config.templateModelCount", { count: template.models }));
										})() })]
									})]
								}, template.id)),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					providerIds.length === 0 && !creating && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						className: "dmp-config-welcome",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.emptyTitle") }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.emptyHint") }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										filteredProviderCards.map((card) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											type: "button",
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
													className: `dmp-key-dot is-${card.keyDot}`,
													title: t(card.keyDot === "configured" ? "config.keyDotConfigured" : card.keyDot === "missing" ? "config.keyDotMissing" : "config.keyDotNone"),
													"aria-hidden": "true"
												})
											]
										}, card.id)),
										filteredProviderCards.length === 0 && providerIds.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: "dmp-config-empty",
											children: t("config.providerSearchEmpty")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												className: "dmp-config-provider-card-main",
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.addProvider") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: t("config.templateSubtitle") })]
											})]
										})
									]
								})]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
							className: "dmp-config-fold",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", { children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dmp-config-fold-title",
										children: t("config.retryTitle")
									}),
									retryDraft.enabled && retryDraft.maxRetries === 50 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dmp-config-retry-preset",
										children: t("config.retryPreset50")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dmp-config-fold-state",
										children: retryDraft.enabled ? t("config.retryFoldOn", { retries: retryDraft.maxRetries }) : t("config.retryFoldOff")
									})
								] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: "dmp-config-fold-hint",
									children: t("config.retryDescription")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dmp-config-provider-grid",
									children: [
					...
					openRouterProfile && !creating && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
						className: "dmp-config-card dmp-config-freesync-card",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
							className: "dmp-config-fold",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "dmp-config-fold-title",
									children: t("config.freeSyncTitle")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "dmp-config-fold-state",
									children: freeSyncDraft?.enabled === true ? t("config.freeSyncOnShort") : t("config.freeSyncOffShort")
								})] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: "dmp-config-fold-hint",
									children: t("config.freeSyncDescription")
								}),
								freeSyncInfo?.lastSyncAt !== void 0 && typeof freeSyncInfo.lastSyncAt === "string" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: renderedModels.map(({ model, index }) => {
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: typeof model.name === "string" && model.name !== "" ? model.name : typeof model.id === "string" && model.id !== "" ? model.id : `${t("config.model")} ${index + 1}` }),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: modelId }),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														className: "dmp-config-model-badges",
														children: [
															typeof model.contextWindow === "number" && Number.isFinite(model.contextWindow) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																title: t("config.contextWindow"),
																children: formatTokenCount(model.contextWindow)
															}),
															typeof model.maxTokens === "number" && Number.isFinite(model.maxTokens) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("em", {
																title: t("config.maxTokens"),
																children: ["↩", formatTokenCount(model.maxTokens)]
															}),
															modelInputMode === "text-image" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																title: t("config.inputTextImage"),
																children: "👁"
															}),
															openRouterProfile && modelId.toLocaleLowerCase().endsWith(":free") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																className: "is-free",
																children: t("config.freeModelBadge")
															}),
															selectedPreset !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																className: "is-preset",
											...
											className: "dmp-config-model-body",
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", { children: t("config.editModel") }),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							hiddenModels > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: "dmp-config-show-all",
								disabled: busy !== null,
								onClick: () => setShowAllModels(true),
								children: t("config.showAllModels", { count: hiddenModels + renderedModels.length })
							})
						]
					}),
					dirty && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dmp-config-savebar",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.unsaved") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: t("config.discardChanges")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							className: "dmp-media-primary",
							type: "button",
							disabled: busy !== null || !dirty && !compatibilityRepair.changed,
    ...
    your-bai-provider:
      ...
      models:
		...
		*/
		...
		function buildBadgeIndex(value) {
			...
			for (const group of value.groups) {
				...
				for (const model of group.models) {
					...
					inner.set(model.id, {
						context: typeof model.contextWindow === "number" && Number.isFinite(model.contextWindow) ? model.contextWindow : void 0,
						output: typeof model.maxTokens === "number" && Number.isFinite(model.maxTokens) ? model.maxTokens : void 0,
		...
		function loadBadgeIndex(api) {
			if (badgeIndex !== null) return Promise.resolve(badgeIndex);
			if (badgePromise === null) badgePromise = api.llm.models({}).then((response) => {
				const index = response.result.ok ? buildBadgeIndex(response.result.value) : /* @__PURE__ */ new Map();
				badgeIndex = index;
				return index;
			}).catch(() => {
				badgePromise = null;
		...
		*/
		function EffortSlider({ value, options, defaultLabel, label, disabled, compact = false, onChange }) {
			...
			if (compact) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `dmp-effort-slider is-compact${disabled ? " is-busy" : ""}`,
				title: `${label}: ${activeName}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: "dmp-effort-slider-value",
					children: activeName
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					type: "range",
					min: 0,
		...
		function ModelPalette({ locked, available, directory, load, select, api, isLoopback, t }) {
			...
			const reasoningOptions = (currentReasoning?.efforts ?? []).filter((effort) => effort.id !== "").slice().sort((left, right) => {
				const leftIndex = REASONING_LEVELS.indexOf(left.id);
				const rightIndex = REASONING_LEVELS.indexOf(right.id);
			...
			const [badges, setBadges] = (0, react.useState)(/* @__PURE__ */ new Map());
			(0, react.useEffect)(() => {
				if (badgeIndex !== null) {
				...
				let cancelled = false;
				loadBadgeIndex(api).then((index) => {
					if (!cancelled) setBadges(index);
				});
				return () => {
					cancelled = true;
				};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					!locked && available && hasEffortControl && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EffortSlider, {
						compact: true,
						value: currentEffort,
					...
					open && (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							role: "dialog",
							"aria-modal": "true",
							"aria-label": t(view === "models" ? "palette.title" : view === "media" ? "media.title" : view === "catalog" ? "config.templateTitle" : view === "config" ? "config.title" : "relay.title"),
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
									className: "dmp-header",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: t(view === "models" ? "palette.title" : view === "media" ? "media.title" : view === "catalog" ? "config.templateTitle" : view === "config" ? "config.title" : "relay.title") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: view === "models" ? `${choices.length} ${t("palette.models")} · ${t("palette.shortcut")}` : view === "catalog" ? t("config.templateHint") : t(view === "media" ? "media.subtitle" : view === "config" ? "config.subtitle" : "relay.subtitle") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: "dmp-close",
										onClick: close,
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("nav", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("palette.navCatalog") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: "＋" })]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("palette.allModels") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: choices.length })]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "dmp-provider-divider" }),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: "dmp-provider-group-label",
												children: t("palette.configuredProviders")
											}),
											providers.map((provider) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: "dmp-rail-icon",
														children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderIcon, {
															id: providerMeta(provider.id).icon,
															size: 14,
															colored: true
														})
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: provider.name }),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: provider.models.length })
												]
											}, provider.id))
										]
									}), view === "media" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MediaPanel, { t }) : view === "config" || view === "catalog" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConfigPanel, {
										api,
										isLoopback,
										mode: view,
																	...
																	children: [
																		...
																		(() => {
																			...
																			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
																				className: "dmp-result-badges",
																				children: [
																					badge.free && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																						className: "is-free",
																						children: "free"
																					}),
																					badge.image && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", {
																						title: "vision",
																						children: "👁"
																					}),
																					badge.context !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: formatTokenCount(badge.context) }),
																					badge.output !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("em", { children: ["↩", formatTokenCount(badge.output)] })
																				]
																			});
																		})(),
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												snapshot.current?.provider !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderIcon, {
													id: providerMeta(snapshot.current.provider).icon,
													size: 14,
													colored: true
												}),
										...
										hasEffortControl && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EffortSlider, {
											value: currentEffort,
											options: reasoningOptions,
											defaultLabel: t("palette.providerDefault"),
											label: t("palette.effort"),
		...
		const zh = {
			...
			"palette.allModels": "全部模型",
			"palette.configuredProviders": "已配置供应商",
			"palette.navCatalog": "添加供应商",
			...
			"config.keyDotConfigured": "密钥已配置",
			"config.keyDotMissing": "密钥未配置",
			"config.keyDotNone": "未声明凭据（目录路由可空）",
			"config.editModel": "展开编辑参数",
			"config.showAllModels": "显示全部 {count} 条模型",
			"config.discardChanges": "放弃更改",
			"config.emptyTitle": "尚未配置任何供应商",
			"config.emptyHint": "从模板目录一键添加 60+ 内置供应商，或手动新建线路。",
			"config.retryFoldOn": "{retries} 次重试",
			"config.retryFoldOff": "未启用",
			"config.freeSyncOnShort": "已开启",
			"config.freeSyncOffShort": "未开启",
			"config.templateTitle": "从模板新增供应商",
			"config.templateSubtitle": "从模板目录选择",
		...
		const en = {
			...
			"palette.allModels": "All models",
			"palette.configuredProviders": "Configured providers",
			"palette.navCatalog": "Add provider",
			...
			"config.backToConfig": "Back to model config",
			...
			"config.keyDotConfigured": "Key configured",
			"config.keyDotMissing": "Key not configured",
			"config.keyDotNone": "No credential declared (catalog routes may be empty)",
			"config.editModel": "Edit parameters",
			"config.showAllModels": "Show all {count} models",
			"config.discardChanges": "Discard changes",
			"config.emptyTitle": "No providers configured yet",
			"config.emptyHint": "Add 60+ built-in providers from the template catalog, or create a route manually.",
			"config.retryFoldOn": "{retries} retries",
			"config.retryFoldOff": "off",
			"config.freeSyncOnShort": "on",
			"config.freeSyncOffShort": "off",
			"config.templateTitle": "Add provider from a template",
			"config.templateSubtitle": "Pick from the template catalog",
