window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function synchronizeOpenRouterFreeModels(models, liveModels) {
			const liveIds = new Set(liveModels.map((model) => model.id));
			let removed = 0;
			return {
				...mergeDiscoveredModels(models.filter((model) => {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
										...
										openRouterProfile && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											disabled: busy !== null,
											onClick: () => void syncOpenRouterFreeModels(),
											children: busy === "openrouter-free" ? t("config.openRouterFreeSyncing") : t("config.openRouterFreeSync")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
		...
		*/
		...
		const zh = {
			...
			"config.openRouterFreeSync": "同步免费模型",
			"config.openRouterFreeSyncing": "正在同步免费模型…",
			"config.openRouterFreeApplied": "OpenRouter 实时目录有 {count} 个可用 :free 模型；已新增 {added} 个、补全 {enriched} 个、清理 {removed} 个失效免费条目，并应用 {presets} 个能力预置。点击“应用配置”后生效。",
		...
		const en = {
			...
			"config.openRouterFreeSync": "Sync free models",
			"config.openRouterFreeSyncing": "Syncing free models…",
			"config.openRouterFreeApplied": "The live OpenRouter catalog contains {count} usable :free models; added {added}, enriched {enriched}, removed {removed} expired free entries, and applied {presets} capability presets. Apply configuration to save them.",
